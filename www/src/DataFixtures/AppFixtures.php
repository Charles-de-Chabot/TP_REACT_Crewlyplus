...
<<<<<<< HEAD
        ...
        $manager->persist($roleCapitain);

        //Role Hotess
        $roleHotess = new Role();
        $roleHotess->setLabel('ROLE_HOTESS');
        $manager->persist($roleHotess);

        //Role chef
        $roleChef = new Role();
        $roleChef->setLabel('ROLE_CHEF');
        $manager->persist($roleChef);
        ...
        //==============================
        // Création des Capitaines
        //==============================
        $arrayCapitain = [
            ['email' => 'capitain1@user.com', 'firstname' => 'Capitain1', 'lastname' => 'nomCapitain1'],
            ['email' => 'capitain2@user.com', 'firstname' => 'Capitain2', 'lastname' => 'nomCapitain2'],
            ['email' => 'capitain3@user.com', 'firstname' => 'Capitain3', 'lastname' => 'nomCapitain3'],
        ];
        foreach ($arrayCapitain as $key => $value) {
            $capitain = new User();
            $capitain->setEmail($value['email']);
            ...
            $capitain->setRole($roleCapitain);

            $manager->persist($capitain);
            $this->addReference('capitain_' . $key, $capitain);
        }

        //==============================
        // Création des Hôtesses
        //==============================
        $arrayHotess = [
            ['email' => 'hotess1@user.com', 'firstname' => 'Hotess1', 'lastname' => 'nomHotess1'],
            ['email' => 'hotess2@user.com', 'firstname' => 'Hotess2', 'lastname' => 'nomHotess2'],
            ['email' => 'hotess3@user.com', 'firstname' => 'Hotess3', 'lastname' => 'nomHotess3'],
        ];
        foreach ($arrayHotess as $key => $value) {
            $hotess = new User();
            $hotess->setEmail($value['email']);
            ...
            $hotess->setRole($roleHotess);

            $manager->persist($hotess);
            $this->addReference('hotess_' . $key, $hotess);
        }
        ...
        //==============================
        $arrayChef = [
            ['email' => 'chef1@user.com', 'firstname' => 'Chef1', 'lastname' => 'nomChef1'],
            ['email' => 'chef2@user.com', 'firstname' => 'Chef2', 'lastname' => 'nomChef2'],
            ['email' => 'chef3@user.com', 'firstname' => 'Chef3', 'lastname' => 'nomChef3'],
        ];
        foreach ($arrayChef as $key => $value) {
            $chef = new User();
            $chef->setEmail($value['email']);
            ...
            $this->addReference('chef_' . $key, $chef);
        }
